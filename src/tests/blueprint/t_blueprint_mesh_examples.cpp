...
TEST(conduit_blueprint_mesh_examples, strided_structured_2d)
{
    ...
    desc["vertex_data/shape"].set(DataType::int8(3));
    int8_array vertex_shape = desc["vertex_data/shape"].as_int8_array();
    vertex_shape[0] = 7;
    vertex_shape[1] = 8;
    vertex_shape[2] = 0;
    desc["vertex_data/origin"].set(DataType::int8(3));
    int8_array vertex_origin = desc["vertex_data/origin"].as_int8_array();
    vertex_origin[0] = 2;
    vertex_origin[1] = 1;
    vertex_origin[2] = 0;
    desc["element_data/shape"].set(DataType::int8(3));
    int8_array element_shape = desc["element_data/shape"].as_int8_array();
    element_shape[0] = 7;
    element_shape[1] = 4;
    element_shape[2] = 0;
    desc["element_data/origin"].set(DataType::int8(3));
    int8_array element_origin = desc["element_data/origin"].as_int8_array();
    element_origin[0] = 0;
    element_origin[1] = 1;
    element_origin[2] = 0;
