...
namespace bputil = conduit::blueprint::util::mesh;
                                 ...
                                 conduit::Node &cdest)
{
    ...
    Node topo_offsets;
    bputil::topology::unstructured::offsets(topo, topo_offsets);
                     ...
                     Node &index_out)
{
    ...
    while(itr.has_next())
    {
        ...
        idx_coordset["coord_system/type"] = bputil::coordset::coordsys(idx_coordset);
