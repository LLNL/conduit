...
//       {
//         static AllocManager inst;
//         return inst;
//       }
//
//       AllocManager(AllocManager const&) = delete;
//       AllocManager(AllocManager&&) = delete;
//       AllocManager& operator=(AllocManager const&) = delete;
//       AllocManager& operator=(AllocManager &&) = delete;
//
...
//           std::cout << "I HEAR YOU " << (m_allocator_id+1) << std::endl;
//           return m_allocator_id++;
//
//       }
//
...
//       {
//         std::cout << "SURE THING USING " << allocator_id << std::endl;
...
//                index_t allocator_id)
//       {
//         std::cout << "LETS CLEAN THAT UP USING " << allocator_id << std::endl;
...
//
//           m_allocator_map[0] = &conduit::utils::default_alloc_handler;
//           m_free_map[0]      = &conduit::utils::default_free_handler;
//           m_allocator_id = 1;
//
...
// //-----------------------------------------------------------------------------
// index_t
// Node::register_allocator(void*(*conduit_hnd_allocate) (size_t, size_t),
//                          void(*conduit_hnd_free)(void *))
// {
...
// //-----------------------------------------------------------------------------
// void *
// Node::conduit_allocate(size_t n_items,
//                        size_t item_size,
//                        index_t allocator_id)
// {
//   return detail::AllocManager::instance().allocate(n_items,item_size,
//                                               allocator_id);
